...
根据杨扬同学的wiki，对VIVI的flash分区进行修改，扩大了内核分区的容量，使用内核版本linux-2.6.25-android-1.0\_r1.tar.gz，详细的配置可以见如下两篇文章:

[移植Linux2.6.22.2到博创2410-S(s3c2410A)](http://blog.chinaunix.net/u2/78837/showart_1182778.html)

[将Android移植到FS2410开发板](http://blog.csdn.net/java211/archive/2009/02/02/3857595.aspx)
...
[移植Linux2.6.22.2到博创2410-S(s3c2410A)（包括AX88796移植）](http://blog.chinaunix.net/u2/78837/showart_1182778.html)
...
[Android根文件系统](http://d.namipan.com/d/b64ce43b2388e5e1f66af18149824b98cd13b926c4921f02)
...
```
设置NFS方式配置参数：
param set linux_cmd_line "console=ttySAC0 root=nfs nfsroot=192.168.0.121:/arm2410s/root ip=192.168.0.115:192.168.0.121:192.168.0.254:255.255.255.0:123:eth0:off init=/init"
其中 设置根文件系统启动方式为NFS方式，192.168.0.121为主机地址，/arm2410s/root为根文件系统路径
192.168.0.115是开发板ip地址，192.168.0.254是主机网关地址，255.255.255.0是子网掩码，123是主机名称，eth0是网卡， init= 设置为文件系统启动执行根目录下的init初始化文件
param save 保存设置
重启VIVI后输入
vivi>boot
